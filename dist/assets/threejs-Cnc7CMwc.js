...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function yl(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:zn,depthTest:!1,depthWrite:!1})}function El(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
...
`)}function Tg(s,e){let t;switch(e){case Lh:t="Linear";break;case Dh:t="Reinhard";break;case Ih:t="Cineon";break;case lc:t="ACESFilmic";break;case Nh:t="AgX";break;case Fh:t="Neutral";break;case Uh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Gs=new C;function bg(){We.getLuminanceCoefficients(Gs);const s=Gs.x.toFixed(4),e=Gs.y.toFixed(4),t=Gs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Rg(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function Qi(s){return s!==""}function Ul(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Nl(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Cg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Va(s){return s.replace(Cg,Lg)}const Pg=new Map;function Lg(s,e){let t=Oe[e];if(t===void 0){const n=Pg.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Va(t)}const Dg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fl(s){return s.replace(Dg,Ig)}function Ig(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ol(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function Ug(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===ac?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===hh?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===xn&&(e="SHADOWMAP_TYPE_VSM"),e}function Ng(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Pi:case Li:e="ENVMAP_TYPE_CUBE";break;case rr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Fg(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===Li&&(e="ENVMAP_MODE_REFRACTION"),e}function Og(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case oc:e="ENVMAP_BLENDING_MULTIPLY";break;case Ch:e="ENVMAP_BLENDING_MIX";break;case Ph:e="ENVMAP_BLENDING_ADD";break}return e}function Bg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function zg(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Ug(t),l=Ng(t),u=Fg(t),h=Og(t),d=Bg(t),f=Ag(t),g=wg(r),x=i.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`,Zr=Object.freeze({ambientCount:82,trailCount:152,ambientRadius:1.35,ambientHeight:.72,ambientOpacity:.105,ambientSize:.46,trailOpacity:.15,trailSize:.54,trailLifetime:2.35,trailSpeedThreshold:.12,fullTrailSpeed:3.2,maxSpawnRate:58,pointScale:235,maxPointSize:42,pixelRatio:1,mistColor:13224132,goldColor:14134357,renderOrder:3});function dx(s){return Math.min(1,Math.max(0,s))}function jl(s,e,t){const n=dx((t-s)/Math.max(1e-6,e-s));return n*n*(3-2*n)}function Zl(s,e){return Number.isFinite(s)&&s>0?Math.floor(s):e}function $l(s,e){if(!e||!Number.isFinite(e.x)||!Number.isFinite(e.y)||!Number.isFinite(e.z))throw new TypeError("DragonMistSystem.update requires finite dragonPosition and dragonVelocity vectors.");return s.set(e.x,e.y,e.z)}function Jl(s){const e=new $t,t=new ft(new Float32Array(s*3),3),n=new ft(new Float32Array(s),1),i=new ft(new Float32Array(s),1),r=new ft(new Float32Array(s),1),a=new ft(new Float32Array(s),1);return t.setUsage(Lo),i.setUsage(Lo),e.setAttribute("position",t),e.setAttribute("aSize",n),e.setAttribute("aOpacity",i),e.setAttribute("aSeed",r),e.setAttribute("aWarmth",a),e.setDrawRange(0,s),e}function fx(s){return new bn({name:"DragonMistProceduralMaterial",vertexShader:hx,fragmentShader:ux,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(2,Math.max(.5,s.pixelRatio))},uPointScale:{value:s.pointScale},uMaxPointSize:{value:s.maxPointSize},uMistColor:{value:new Pe(s.mistColor)},uGoldColor:{value:new Pe(s.goldColor)}},transparent:!0,depthTest:!0,depthWrite:!1,premultipliedAlpha:!0,blending:ti,toneMapped:!0})}class px{constructor(e,t={}){if(e!=null&&!e.isObject3D)throw new TypeError("DragonMistSystem parent must be a THREE.Object3D.");this.options={...Zr,...t},this.options.ambientCount=Zl(this.options.ambientCount,Zr.ambientCount),this.options.trailCount=Zl(this.options.trailCount,Zr.trailCount),this._random=typeof t.random=="function"?t.random:Math.random,this.group=new Bn,this.group.name="dragon-mist-system",this.group.matrixAutoUpdate=!0,this.group.frustumCulled=!1,this._ambientGeometry=Jl(this.options.ambientCount),this._trailGeometry=Jl(this.options.trailCount),this._ambientMaterial=fx(this.options),this._trailMaterial=this._ambientMaterial.clone(),this._trailMaterial.name="DragonMistTrailProceduralMaterial",this.ambientMist=new Ha(this._ambientGeometry,this._ambientMaterial),this.ambientMist.name="dragon-mist-ambient",this.ambientMist.frustumCulled=!1,this.ambientMist.renderOrder=this.options.renderOrder,this.trailMist=new Ha(this._trailGeometry,this._trailMaterial),this.trailMist.name="dragon-mist-trail",this.trailMist.frustumCulled=!1,this.trailMist.renderOrder=this.options.renderOrder-1,this.group.add(this.trailMist,this.ambientMist),e&&e.add(this.group),this._time=0,this._flightAmount=0,this._spawnAccumulator=0,this._trailCursor=0,this._hasPreviousPosition=!1,this._disposed=!1,this._dragonPosition=new C,this._previousPosition=new C,this._velocity=new C,this._direction=new C(1,0,0),this._side=new C,this._binormal=new C,this._scratch=new C,this._ambientPhase=new Float32Array(this.options.ambientCount),this._ambientRadius=new Float32Array(this.options.ambientCount),this._ambientHeight=new Float32Array(this.options.ambientCount),this._ambientSpeed=new Float32Array(this.options.ambientCount),this._ambientPulse=new Float32Array(this.options.ambientCount),this._trailAge=new Float32Array(this.options.trailCount),this._trailLife=new Float32Array(this.options.trailCount),this._trailVelocity=new Float32Array(this.options.trailCount*3),this._trailDrift=new Float32Array(this.options.trailCount*3),this._initializeAmbientParticles(),this.clearTrail()}_initializeAmbientParticles(){const{ambientCount:e,ambientRadius:t,ambientHeight:n,ambientOpacity:i,ambientSize:r}=this.options,a=this._ambientGeometry.attributes.position.array,o=this._ambientGeometry.attributes.aSize.array,c=this._ambientGeometry.attributes.aOpacity.array,l=this._ambientGeometry.attributes.aSeed.array,u=this._ambientGeometry.attributes.aWarmth.array;for(let h=0;h<e;h++){const d=(h+this._random()*.7)/e;this._ambientPhase[h]=d*Xs,this._ambientRadius[h]=t*(.48+this._random()*.58),this._ambientHeight[h]=(this._random()*2-1)*n,this._ambientSpeed[h]=.12+this._random()*.2,this._ambientPulse[h]=this._random()*Xs;const f=h*3;a[f]=0,a[f+1]=0,a[f+2]=0,o[h]=r*(.68+this._random()*.72),c[h]=i*(.58+this._random()*.42),l[h]=this._random(),u[h]=.06+this._random()*.16}this._ambientGeometry.attributes.aSize.needsUpdate=!0,this._ambientGeometry.attributes.aOpacity.needsUpdate=!0,this._ambientGeometry.attributes.aSeed.needsUpdate=!0,this._ambientGeometry.attributes.aWarmth.needsUpdate=!0}_updateAmbientParticles(e){const{ambientCount:t,ambientOpacity:n}=this.options,i=this._ambientGeometry.attributes.position,r=this._ambientGeometry.attributes.aOpacity,a=i.array,o=r.array;for(let c=0;c<t;c++){const l=this._ambientPhase[c]+this._time*this._ambientSpeed[c],u=1+Math.sin(this._time*.72+this._ambientPulse[c])*.075,h=this._ambientRadius[c]*u,d=c*3;a[d]=Math.cos(l)*h,a[d+1]=this._ambientHeight[c]+Math.sin(l*1.7+this._time*.18)*.13,a[d+2]=Math.sin(l)*h*.64;const f=.78+Math.sin(this._time*.61+this._ambientPulse[c])*.22,g=1-this._flightAmount*.2;o[c]=n*f*g}i.needsUpdate=!0,r.needsUpdate=!0,this.ambientMist.position.copy(this._dragonPosition),this.ambientMist.updateMatrix()}_spawnTrailParticle(e,t){const n=this._trailCursor;this._trailCursor=(this._trailCursor+1)%this.options.trailCount;const i=this._trailGeometry.attributes.position.array,r=this._trailGeometry.attributes.aSize.array,a=this._trailGeometry.attributes.aOpacity.array,o=this._trailGeometry.attributes.aSeed.array,c=this._trailGeometry.attributes.aWarmth.array,l=n*3;this._scratch.lerpVectors(this._previousPosition,this._dragonPosition,e);const u=.15+this._random()*(.35+t*.55),h=(this._random()*2-1)*(.18+t*.22),d=(this._random()*2-1)*.2;this._scratch.addScaledVector(this._direction,-u).addScaledVector(this._side,h).addScaledVector(this._binormal,d),i[l]=this._scratch.x,i[l+1]=this._scratch.y,i[l+2]=this._scratch.z,r[n]=this.options.trailSize*(.7+this._random()*.75)*(.84+t*.3),a[n]=.001,o[n]=this._random(),c[n]=.08+this._random()*.22,this._trailAge[n]=0,this._trailLife[n]=this.options.trailLifetime*(.72+this._random()*.52);const f=.035+this._random()*.035;this._trailVelocity[l]=this._velocity.x*f+this._side.x*h*.16,this._trailVelocity[l+1]=this._velocity.y*f+.055+this._random()*.08,this._trailVelocity[l+2]=this._velocity.z*f+this._side.z*h*.16,this._trailDrift[l]=this._random()*Xs,this._trailDrift[l+1]=this._random()*Xs,this._trailDrift[l+2]=.35+this._random()*.65}_updateTrailParticles(e,t,n){const i=this._trailGeometry.attributes.position,r=this._trailGeometry.attributes.aOpacity,a=this._trailGeometry.attributes.aSize,o=this._trailGeometry.attributes.aSeed,c=this._trailGeometry.attributes.aWarmth,l=i.array,u=r.array;for(let h=0;h<this.options.trailCount;h++){const d=this._trailLife[h];if(d<=0)continue;const f=h*3,g=this._trailAge[h]+e;if(this._trailAge[h]=g,g>=d){this._trailLife[h]=0,u[h]=0;continue}const x=g/d,m=this._trailDrift[f+2],p=Math.sin(this._time*m+this._trailDrift[f])*.035,b=Math.cos(this._time*m*.83+this._trailDrift[f+1])*.035;l[f]+=(this._trailVelocity[f]+p)*e,l[f+1]+=this._trailVelocity[f+1]*e,l[f+2]+=(this._trailVelocity[f+2]+b)*e;const T=jl(0,.12,x),M=Math.pow(1-x,1.65),w=t<this.options.trailSpeedThreshold?Math.exp(-x*2.2):1;u[h]=this.options.trailOpacity*T*M*w}if(t>=this.options.trailSpeedThreshold&&e>0){const h=this.options.maxSpawnRate*(.28+n*.72);this._spawnAccumulator+=h*e;const d=Math.min(8,Math.floor(this._spawnAccumulator));this._spawnAccumulator-=d;for(let f=0;f<d;f++)this._spawnTrailParticle((f+1)/(d+1),n)}else this._spawnAccumulator=Math.min(this._spawnAccumulator,.99);i.needsUpdate=!0,r.needsUpdate=!0,a.needsUpdate=!0,o.needsUpdate=!0,c.needsUpdate=!0}update(e,t,n){if(this._disposed)return this;const i=Math.min(.1,Math.max(0,Number.isFinite(e)?e:0));$l(this._dragonPosition,t),$l(this._velocity,n),this._hasPreviousPosition||(this._previousPosition.copy(this._dragonPosition),this._hasPreviousPosition=!0),this._time+=i;const r=this._velocity.length(),a=jl(this.options.trailSpeedThreshold,this.options.fullTrailSpeed,r),o=r>=this.options.trailSpeedThreshold?a:0;this._flightAmount+=(o-this._flightAmount)*(1-Math.exp(-i*5.5)),r>1e-5&&this._direction.copy(this._velocity).normalize();const c=Math.abs(this._direction.dot(Kl))>.94?cx:Kl;return this._side.crossVectors(this._direction,c).normalize(),this._binormal.crossVectors(this._side,this._direction).normalize(),this._ambientMaterial.uniforms.uTime.value=this._time,this._trailMaterial.uniforms.uTime.value=this._time,this._updateAmbientParticles(i),this._updateTrailParticles(i,r,a),this._previousPosition.copy(this._dragonPosition),this}setPixelRatio(e){const t=Math.min(2,Math.max(.5,Number.isFinite(e)?e:1));return this._ambientMaterial.uniforms.uPixelRatio.value=t,this._trailMaterial.uniforms.uPixelRatio.value=t,this}setVisible(e){return this.group.visible=!!e,this}clearTrail(){return this._trailAge.fill(0),this._trailLife.fill(0),this._trailGeometry.attributes.aOpacity.array.fill(0),this._trailGeometry.attributes.aOpacity.needsUpdate=!0,this._spawnAccumulator=0,this}dispose(){this._disposed||(this._disposed=!0,this.group.removeFromParent(),this._ambientGeometry.dispose(),this._trailGeometry.dispose(),this._ambientMaterial.dispose(),this._trailMaterial.dispose())}}const jc=document.querySelector("#dragon-canvas"),Ql=document.querySelector("#loading-screen"),mx=document.querySelector("#loading-bar"),ec=document.querySelector("#loading-detail"),tc=document.querySelector("#load-status"),gx=document.querySelector("#fps-readout"),nc=document.querySelector("#ready-toast"),ic=document.querySelector("#rotate-toggle"),_x=document.querySelector("#mist-toggle"),xx=document.querySelector("#reset-camera"),Xa=document.querySelector("#deck-state"),ai=new f_({canvas:jc,antialias:!0,alpha:!0,powerPreference:"high-performance"});ai.setPixelRatio(Math.min(window.devicePixelRatio,2));ai.setSize(window.innerWidth,window.innerHeight,!1);ai.toneMapping=lc;ai.toneMappingExposure=1.1;ai.outputColorSpace=vt;const wn=new Bu;wn.background=null;wn.fog=new no(526343,.04);const si=new wt(45,window.innerWidth/window.innerHeight,.1,100);si.position.set(0,1.4,5.5);const vx=si.position.clone(),Zc=new C(0,.8,0),Hn=new Z_(si,jc);Hn.target.copy(Zc);Hn.enableDamping=!0;Hn.dampingFactor=.06;Hn.minDistance=2.5;Hn.maxDistance=12;Hn.maxPolarAngle=Math.PI*.85;const Mx=new gd(16773328,.4);wn.add(Mx);const $c=new ho(16766330,1.6);$c.position.set(4,6,4);wn.add($c);const Jc=new ho(5164484,.6);Jc.position.set(-5,3,-3);wn.add(Jc);const Qc=new kc(16742954,1.2,8);Qc.position.set(0,-.5,1.5);wn.add(Qc);const eh=new px(wn,{count:220});let vn=null,Qs=!0,qs=!0;const Sx=new p_;Sx.load("./../../dragon/scene.gltf",s=>{vn=s.scene,vn.scale.set(.9,.9,.9),vn.position.set(0,0,0),vn.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),wn.add(vn),yx(),Ex(),tc.textContent="已就绪"},s=>{if(s.total){const e=s.loaded/s.total*100;mx.style.transform=`scaleX(${e/100})`,ec.textContent=`预载 glTF · ${Math.round(e)}% · ${(s.loaded/1024/1024).toFixed(1)} MB`}},s=>{console.error(s),ec.textContent="模型加载失败",tc.textContent="错误"});function yx(){Ql.style.opacity="0",setTimeout(()=>{Ql.style.display="none"},600)}function Ex(){nc.classList.add("is-visible"),window.setTimeout(()=>{nc.classList.remove("is-visible")},2400)}ic.addEventListener("click",()=>{Qs=!Qs,ic.querySelector(".launch-button__label").textContent=Qs?"暂停旋转":"继续旋转"});_x.addEventListener("click",()=>{qs=!qs,eh.setVisible(qs),Xa.textContent=qs?"雾效已开":"雾效已关"});xx.addEventListener("click",()=>{si.position.copy(vx),Hn.target.copy(Zc),Xa.textContent="已复位",setTimeout(()=>{Xa.textContent="拖拽旋转 · 滚轮缩放"},1500)});window.addEventListener("resize",()=>{si.aspect=window.innerWidth/window.innerHeight,si.updateProjectionMatrix(),ai.setSize(window.innerWidth,window.innerHeight,!1)});let $r=0,sc=performance.now();const rc=new vd;function th(){requestAnimationFrame(th);const s=rc.getDelta(),e=rc.getElapsedTime();Qs&&vn&&(vn.rotation.y+=s*.25),vn&&(vn.position.y=Math.sin(e*.8)*.05),eh.update(s,e),Hn.update(),ai.render(wn,si),$r++;const t=performance.now();t-sc>=1e3&&(gx.textContent=`${$r} fps`,$r=0,sc=t)}th();
